  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6 lg:p-6">
        ...
        {project.description && (
          <p className="mt-3 sm:mt-4 max-w-2xl text-sm sm:text-base text-muted">
            {project.description}
          </p>
        )}
        ...
        {project.skillsLearned && project.skillsLearned.length > 0 && (
          <div className="mt-4 sm:mt-6">
            <p className="text-xs sm:text-sm font-semibold text-muted mb-2">
              Habilidades aprendidas:
            </p>
...
function ProjectCard({ project }) {
  return (
    ...
    >
      ...
      <div className="mt-4 sm:mt-4 flex flex-wrap gap-1 sm:gap-2 px-4 sm:px-5 pb4 sm:pb-5">
        {project.github && (
          <a
            href={project.github}
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-border px-4 py-2  text-sm sm:text-base transition-colors hover:border-accent hover:text-accent"
          >
            <Github size={16} sm:size={18} /> Repositorio
          </a>
        )}
